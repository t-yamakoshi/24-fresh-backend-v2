...
import (
	...
	"github.com/t-yamakoshi/24-fresh-backend-v2/schema/db/ent/entgen/migrate"
...
func (c *UserModelClient) UpdateOneID(id int) *UserModelUpdateOne {
...
func (c *UserModelClient) DeleteOneID(id int) *UserModelDeleteOne {
...
func (c *UserModelClient) Get(ctx context.Context, id int) (*UserModel, error) {
	return c.Query().Where(usermodel.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserModelClient) GetX(ctx context.Context, id int) *UserModel {
